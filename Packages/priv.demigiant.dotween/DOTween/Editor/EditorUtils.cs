...
namespace DG.DOTweenEditor
{
    public static class EditorUtils
    {
        ...
        public const string packageId = "priv.demigiant.dotween";
        ...
        public static void SetEditorTexture(Texture2D texture, FilterMode filterMode = FilterMode.Point, int maxTextureSize = 32)
        {
            ...
            tImporter.textureCompression = TextureImporterCompression.CompressedHQ;// TextureImporterFormat.AutomaticTruecolor;
